...
def paying_debt_offin_a_year(balance, annual_interest_rate):
    ...
    while balance > 0:
        ...
        for _ in range(12):
            monthly_unpaid_balance = balance - assume_val
            updated_balance_eachmonth = monthly_unpaid_balance + (monthly_interest_rate*monthly_unpaid_balance)
...
def main():
    ...
    print(str(paying_debt_offin_a_year(data[0], data[1])))
